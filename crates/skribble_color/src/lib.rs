...
impl Color {
	...
	/// # Arguments
	///
	/// - red - The amount of red light, where `0.0` is no red light and `1.0`
	...
	/// - blue - The amount of blue light, where `0.0` is no blue light and
	///   `1.0` is the highest displayable amount.
	...
	/// is the highest displayable amount.
	/// - green - The amount of green light, where 0u8 is no green light and
	///   255u8 is the highest displayable amount.
	/// - blue - The amount of blue light, where 0u8 is no blue light and 255u8
	///   is the highest displayable amount.
	...
	/// - `whiteness` - The whiteness of the color. It specifies the amount
	///   white to mix into the hue. It varies from `0.0` to `1.0`, with `1.0`
	///   being always full white and `0.0` always being the color shade (a
	///   mixture of a pure hue with black) chosen with the other two controls.
	/// - `blackness` - The blackness of the color. It specifies the amount
	///   black to mix into the hue. It varies from 0 to 1, with 1 being always
	///   full black and 0 always being the color tint (a mixture of a pure hue
	///   with white) chosen with the other two controls.
	...
	///   and `1.0` will give a bright an clear color that goes towards white
	///   when `saturation` goes towards `0.0`.
	/// - `alpha` - The transparency component. `0.0` is fully transparent and
	///   `1.0` is fully opaque.
	...
	/// # Arguments
	///
	/// - `l`- the lightness of the color. `0.0` gives absolute black and
	///   `100.0`
	...
	/// saturated colors. The upper limit of 128 should include the whole
	/// L\*a\*b\* space and some more.
	/// - `hue` of the color, in degrees. Decides if it's red, blue, purple,
	///   etc.
	...
	/// # Arguments
	///
	/// - `l` is the lightness of the color. `0.0` gives absolute black and
	///   `1.0` gives the brightest white.
	...
	/// Returns the color as an OKLCH value. Will remain unchanged if the color
	/// is already in the OKLCH format.
	...
	/// Returns the color as an OKLAB value. Will remain unchanged if the color
	/// is already in the OKLAB format.
	...
	/// Get a reference to the inner hex value if the current color is in the
	/// hex format.
	...
	/// Get a mutable reference to the inner hex value if the current color is
	/// in the hex format.
	...
	/// Get a reference to the inner rgb value if the current color is in the
	/// rgb format.
	...
	/// Get a mutable reference to the inner rgb value if the current color is
	/// in the rgb format.
	...
	/// Get a reference to the inner hsl value if the current color is in the
	/// hsl format.
	...
	/// Get a mutable reference to the inner hsl value if the current color is
	/// in the hsl format.
	...
	/// Get a reference to the inner hwb value if the current color is in the
	/// hwb format.
	...
	/// Get a mutable reference to the inner hwb value if the current color is
	/// in the hwb format.
	...
	/// Get a reference to the inner lch value if the current color is in the
	/// lch format.
	...
	/// Get a mutable reference to the inner lch value if the current color is
	/// in the lch format.
	...
	/// Get a reference to the inner lab value if the current color is in the
	/// lab format.
	...
	/// Get a mutable reference to the inner lab value if the current color is
	/// in the lab format.
	...
	/// Get the alpha value of the current color as an [`f32`] value between
	/// `0.0` and `1.0`.
