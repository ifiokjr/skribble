...
pub enum MergeRule {
	...
	Ignore,
	/// The configuration will be reset to the default value and neither the
	/// user configuration nor the plugin configuration will be used (not
	/// recommended - mainly here for completeness)..
	Reset,
}
